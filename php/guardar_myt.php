...
include 'conexion.php';
			...
			$tipo_radi1 		= $_POST["tipo_radi"];
			$radi_reco_ant1 	= $_POST["radi_reco_ant"];
			$ca_doc1 			= $_POST["ca_doc"];
			$fp_doc1 			= $_POST["fp_doc"];
			$of_doc1 			= $_POST["of_doc"];
			$si_doc1 			= $_POST["si_doc"];
			$ca_folio1 			= $_POST["ca_folio"];
			$fp_folio1 			= $_POST["fp_folio"];
			$of_folio1 			= $_POST["of_folio"];
			$si_folio1 			= $_POST["si_folio"];
			$radi_ant_reposa1 	= $_POST["radi_ant_reposa"];
			$cod_usua1 			= $_POST["cod_usua"];
